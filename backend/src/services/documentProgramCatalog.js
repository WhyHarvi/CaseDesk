...
export const GLOBAL_CASE_TYPE_PROGRAMS = [
  {
    ...
    aliases: ["Temporary Resident Visa", "Temporary Resident Visa (TRV)", "Tourist Visa", "Visitor Visa - TRV", "Visitor Visa", "TRV"],
  ...
  },
  {
    ...
    title: "Work Permit",
    category: "Temporary residence",
    aliases: ["Employer-specific Work Permit", "Open Work Permit", "Work permit / Open Work permit"],
  ...
  },
  {
    ...
    aliases: ["Spouse/Common-Law/Conjugal Partner Sponsorship", "Spousal Sponsorship", "Spousal and Family Sponsorship"],
  ...
  },
  {
    ...
    aliases: ["Citizenship Grant", "Adult Citizenship", "Canadian Citizenship"],
    sourceUrl: sources.forms,
