...
const CASE_TYPE_ALIASES = new Map([
  ...
  ["permanent resident card renewal", "PR Card Renewal"],
  ["india passport renewal", "Indian Passport Renewal"],
  ["canada passport renewal", "Canadian Passport Renewal"],
  ["oci application", "OCI Card Application"],
  ["oci card apply", "OCI Card Application"],
  ["overseas citizen of india card application", "OCI Card Application"],
