  ...
  return (
    <div className="space-y-5">
      ...
      <section className={card}>
        ...
        <p className="mt-4 text-xs text-slate-400">Coming next after the connection: account mapping (fees vs. government-fee disbursements), the case billing tab, and milestone payment schedules.</p>
      </section>
    </div>
  );
}
