          ...
          <>
            ...
            <section className={card}>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50/70 p-3.5">
                ...
                <label className="text-xs font-medium text-slate-600">Hold window (min) <input type="number" min="10" max="120" disabled={!settings.consultFeeEnabled} value={settings.consultFeeHoldMinutes} onChange={(event) => setSettings((c) => ({ ...c, consultFeeHoldMinutes: Number(event.target.value) }))} className={`${inputClass} ml-2 w-20`} /></label>
