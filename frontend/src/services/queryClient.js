...
const RELATED_PATHS = {
  ...
  documents: ["documents", "client-documents", "written-documents", "cases", "clients", "dashboard"],
  "client-documents": ["documents", "client-documents", "written-documents", "cases", "clients", "dashboard"],
  "written-documents": ["documents", "client-documents", "written-documents", "cases", "clients", "dashboard"],
