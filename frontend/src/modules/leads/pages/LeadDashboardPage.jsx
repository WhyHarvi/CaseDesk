...
function LeadNameButton({ lead, onOpen }) {
  return <button type="button" onClick={() => onOpen(lead)} className="max-w-full truncate text-left text-sm font-semibold text-slate-900 outline-none hover:text-brand-700 hover:underline focus-visible:text-brand-700 focus-visible:underline">{leadName(lead)}</button>;
}
